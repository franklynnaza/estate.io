...
<body class="blog-page">
  ...
  <section class="blog-about about">
    ...
    <div class="features-p">
      <span class="features-main d-flex"><h6 class="h6 color-primary my-2 btn btn-theme">FOR RENT</h6>
      <h4 class="mx-3 my-3">₦<?php echo number_format($property['price'], 0); ?></h4></span>
      <div class="col ">
      
        <button class="btn btn-theme buy"><a href="tel:+234 808 467 1148">Buy Now</a></button>
